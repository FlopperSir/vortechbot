...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (sellerkey === null) return interaction.editReply({ embeds: [new EmbedBuilder().setDescription(`***ERROR***`).setColor(Colors.Red).setTimestamp()], ephemeral: ephemeral })
